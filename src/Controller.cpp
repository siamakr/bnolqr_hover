...
// const uint16_t Controller::servo_pins[] = { SERVO_1_PIN, SERVO_2_PIN, SERVO_3_PIN, SERVO_4_PIN };
...
// void Controller::set_servo_offsets( int16_t * offsets ){
//     for (uint8_t i = 0; i < 4; i++)
//     {   
...
// void Controller::write_motor( uint8_t index, uint16_t throttle ){
...
// void Controller::write_servo( uint8_t index, float angle )
// {
...
// void Controller::write_servo_ms( uint8_t index, uint16_t ms ){
//     servos[index].writeMicroseconds( ms );
// }


// void Controller::read_control_input(){
...
// void Controller::control_hover( float roll, float pitch, float yaw, float gx, float gy, float gz, float z, float vz ){
...
// void Controller::set_reference( control_setpoint_t id, float value ){
...
// void Controller::control_position( float x, float y, float vx, float vy, float yaw ){
...
// void Controller::initiate_landing(){
//     status = CONTROL_STATUS_LANDING;
//     set_reference( SETPOINT_Z, 0 );
// }

// void Controller::initiate_takeoff( float target_altitude ){
//     status = CONTROL_STATUS_FLYING;
//     set_reference( SETPOINT_Z, target_altitude );
// }

// void Controller::run( sensor_data_t raw, estimator_data_t est ){
...
// void Controller::reset_integral_action( void ){
//     error_integral_x = 0;
//     error_integral_y = 0;
//     error_integral_z = 0;
// }

// void Controller::set_max_throttle( uint16_t dshot ){
//     max_throttle = dshot;
// }

// void Controller::servo_calibration( int16_t * servo_offset ){
...
// float Controller::RateLimit( float new_sample, float old_sample, float alpha ){
